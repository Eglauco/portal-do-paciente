...
class UnidadeControllerTest {
    ...
    void listaUnidadesSemeadas() {
        Pagina<Unidade> pagina = controller.listar(null, null, null, 0, 10);
    ...
    @Test
    void filtraPorNome() {
        Pagina<Unidade> pagina = controller.listar(null, "Policl", null, 0, 10);
    ...
    void tamanhoAcimaDoLimiteEhReduzidoPara100() {
        Pagina<Unidade> pagina = controller.listar(null, null, null, 0, 500);
