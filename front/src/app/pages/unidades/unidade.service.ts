...
export class UnidadeService {
  ...
  readonly base = `${environment.apiUrl}/unidade`;
  ...
  /** Exporta as unidades dos filtros atuais em Excel ou PDF, só com as colunas escolhidas. */
  exportar(formato: 'xlsx' | 'pdf', filtro: UnidadeFiltro = {}, colunas: string[] = []): Observable<Blob> {
