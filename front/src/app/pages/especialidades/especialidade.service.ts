...
export class EspecialidadeService {
  ...
  /** Exporta as especialidades dos filtros/ordenação atuais em Excel ou PDF, só com as colunas escolhidas. */
  exportar(
    formato: 'xlsx' | 'pdf',
    filtro: EspecialidadeFiltro = {},
    colunas: string[] = [],
