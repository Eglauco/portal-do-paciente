...
export class ProfissionalSaudeService {
  ...
  /** Exporta os profissionais dos filtros atuais em Excel ou PDF, só com as colunas escolhidas. */
  exportar(formato: 'xlsx' | 'pdf', filtro: ProfissionalSaudeFiltro = {}, colunas: string[] = []): Observable<Blob> {
