  ...
  constructor() {
    ...
    if (idParam) {
      ...
      this.service.buscarPorId(id).subscribe({
        next: (profissional) => this.form.patchValue({ nome: profissional.nome }),
  ...
  protected salvar(event: Event): void {
    ...
    requisicao.subscribe({
      ...
      error: () => {
        ...
        this.toastr.error('Não foi possível salvar o profissional.');
      },
    });
  }
  ...
  protected async excluir(): Promise<void> {
    ...
    this.service.excluir(this.codigo()!).subscribe({
      ...
      error: () => {
        ...
        this.toastr.error('Não foi possível excluir o profissional.');
      },
    });
  }
