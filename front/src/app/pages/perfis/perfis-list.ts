...
export class PerfisList {
  ...
  protected readonly tamanhos = PerfilService.TAMANHOS;
  protected readonly size = signal(PerfilService.TAMANHO_PADRAO);
  ...
  protected readonly fimFaixa = computed(() => this.page() * this.size() + this.perfis().length);
